<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Empleados.aspx.cs" Inherits="GUI.Empleados" %>
      ...
      <%--  <asp:DropDownList ID="dropdownDepartamento" runat="server" OnSelectedIndexChanged="dropdownDepartamento_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>--%>
         ...
         <div class="row">
             <div class="col-md-12 border shadow rounded">
                 <br />
             <h4 class="font-weight-bold mb-0">Alta de Empleado</h4>
            ...
            <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                    ...
                    <asp:TextBox textmode="Number" ID="txtLegajo" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                   <br />
            <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                ...
                <asp:TextBox textmode="Number" ID="txtCuil" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
                 <br />
                 <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                ...
                <asp:DropDownList ID="dropdownDivision" runat="server" OnSelectedIndexChanged="dropdownDivision_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
            </div>
                   <br />
                 <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                ...
                <asp:DropDownList ID="dropdownCategorias" runat="server"></asp:DropDownList>
            </div>
                           <br />
            <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                   ...
                   <asp:TextBox TextMode="Number" ID="txtCuenta" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                       <br />
            <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                ...
                <asp:DropDownList ID="dropdownBancos" runat="server"></asp:DropDownList>
                </div>
                   <br />
                 <asp:Label ID="lblSuccess" runat="server" CssClass="alert alert-success" Text="Empleado agregado!" Visible="false"></asp:Label>
                 <asp:Button ID="btnAlta" class="btn btn-info" runat="server" Text="Agregar Empleado" OnClick="btnAlta_Click" />
                 <br />
                 <br />
             </div>
