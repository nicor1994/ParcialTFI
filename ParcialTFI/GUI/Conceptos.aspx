<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Conceptos.aspx.cs" Inherits="GUI.Conceptos" %>
    ...
    <form id="form1" runat="server">
         ...
         <div class="row">
             <div class="col-md-12 border shadow rounded">
                 <br />
             <h4 class="font-weight-bold mb-0">Alta de Concepto</h4>
            ...
            <div class="input-group flex-nowrap">
                 ...
                 <asp:DropDownList ID="dropdownConcepto" runat="server" ></asp:DropDownList>
                </div>
            ...
            <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                   ...
                   <asp:DropDownList ID="dropdownValor" runat="server" ></asp:DropDownList>
                </div>
                   <br />
            <div class="input-group flex-nowrap">
                  <div class="input-group-prepend">
                ...
                <asp:TextBox textmode="Number" ID="txtValor" CssClass="form-control" runat="server"></asp:TextBox>
                 ...
                 <asp:Button ID="btnAlta" class="btn btn-info" runat="server" Text="Agregar Concepto" OnClick="btnAlta_Click"/>
                 <br />
                 <br />
             </div>
